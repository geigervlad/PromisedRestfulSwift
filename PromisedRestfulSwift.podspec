Pod::Spec.new do |podspec|
  ...
  podspec.homepage         = 'https://github.com/geigervlad/PromisedRestfulSwift'
  podspec.license          = { :type => 'MIT', :file => 'LICENSE' }
  podspec.author           = { 'Vlad Geiger' => 'geiger.vlad.mihaly@gmail.com' }
  podspec.source           = { :git => 'https://github.com/geigervlad/PromisedRestfulSwift.git', :tag => podspec.version.to_s }
  podspec.ios.deployment_target = '11.4'
  podspec.swift_version   = '5.0'
  podspec.source_files = 'PromisedRestfulSwift Sources/Sources/**/*'
